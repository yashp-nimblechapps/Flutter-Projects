...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/askQues', builder: (context, state) => const AskQuestionScreen()),
      GoRoute(path: '/saved', builder: (context, state) => const SavedQuestionsScreen()),

      GoRoute(path: '/detailQues/:id', builder: (context, state) {
      ...
      GoRoute(path: '/accDetail', builder: (context, state) => const AccountDetailScreen()),
      GoRoute(path: '/accStatus', builder: (context, state) => const AccountStatusScreen()),
      GoRoute(path: '/theme', builder: (context, state) => const ThemeChangeScreen()),
      GoRoute(path: '/notificationSettings', builder: (context, state) => const NotificationSettingsScreen()),
      GoRoute(path: '/aboutApp', builder: (context, state) => const AboutAppScreen()),
      ...
      GoRoute(path: '/admin', builder: (context, state) => const AdminDashboardScreen(),
        routes: [
          GoRoute(path: '/adminProfile', builder: (context, state) => const AdminProfileScreen()),
          GoRoute(path: '/userManage', builder: (context, state) => const UserManagementScreen()),
          GoRoute(path: '/tagManage', builder: (context, state) => const TagManagementScreen()),
          GoRoute(path: '/moderation', builder: (context, state) => const ModerationScreen()),

          GoRoute(path: '/moderation/:id', builder: (context, state) {
              final id = state.pathParameters['id']!;
          ...
          GoRoute(path: '/report', builder: (context, state) => const AdminReportsScreen()), 
          GoRoute(path: '/adminAccStatus', builder: (context, state) => const AdminAccountStatusScreen()),    
        ],
      ),
