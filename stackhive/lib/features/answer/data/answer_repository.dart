...
class AnswerRepository {
  ...
  Future<void> markBestAnswer({
    ...
    // Reset previous best only if exists
    ...
    // Fetch answer owner for notification + data
    final answerSnapshot = await selectedAnswerRef.get();
    ...
    // Prevent self notification
    if (answerOwnerId != null && answerOwnerId != currentUserId) {
