...
import 'package:stackhive/features/question/presentation/widget/showDeleteQuestionSheet.dart';
                        ...
                        if (isQuestionOwner)
                          _sheetTile(
                            ...
                            onTap: () async {
                              ...
                              Navigator.pop(context);
                              showDeleteQuestionSheet(
                                context,
                                q,
                                repo: repo,
                                paginatedNotifier: notifier,
                              );
                            },
                          ),
                      ],
